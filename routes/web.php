...
Route::post('comments/store/{id}',[\App\Http\Controllers\Admin\CommentController::class,'storeComments']);
Route::post('comments/reply/{id}',[\App\Http\Controllers\Admin\CommentController::class,'replyComments']);
