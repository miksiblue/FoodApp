...
Route::post('comments/store/{id}',[\App\Http\Controllers\Admin\CommentController::class,'storeFoodComments']);
Route::post('comments/reply/{id}',[\App\Http\Controllers\Admin\CommentController::class,'replyFoodComments']);

Route::get('comments/{id}',[\App\Http\Controllers\Admin\FoodController::class,'show']);
Route::get('restaurantComments/{id}',[\App\Http\Controllers\V1\RestaurantController::class,'showComments']);
Route::post('comments/store1/{id}',[\App\Http\Controllers\Admin\CommentController::class,'storeRestaurantComments']);
Route::post('comments/reply1/{id}',[\App\Http\Controllers\Admin\CommentController::class,'replyRestaurantComments']);
